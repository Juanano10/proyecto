...
function HomePage() {
  ...
  const [currentPage, setCurrentPage] = useState(0); // Cambiamos el valor inicial a 0
  ...
  <div className="text-gray-900 font-semibold" style={{ maxWidth: "150px", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
    {product.name}
  </div>
</td>
<td className="border-r border-black py-2 px-4 text-left">
  <div className="text-gray-900 font-semibold" style={{ maxWidth: "100px", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
    {product.price}
  </div>
</td>
<td className="border-r border-black py-2 px-4 text-left">
  <div className="text-gray-900 font-semibold" style={{ maxWidth: "200px", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
    {product.description}
  </div>
</td>
<td className="border-r border-black py-2 px-4 text-left">
